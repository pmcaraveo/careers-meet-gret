...
namespace MyAlfaLive.Controllers
{
    [Authorize]
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user != null)
            {
                ...
                if (!user.Activo)
                {
                    ModelState.AddModelError(String.Empty, "Sin acceso al sistema.");
                    return View(model);
                }
                ...
                if (!await UserManager.IsEmailConfirmedAsync(user.Id))
                {
                    ...
                    ModelState.AddModelError(String.Empty, "Debes confirmar tu correo para poder ingresar.");
                    return View(model);
                }
            }
            ...
            switch (result)
            {
                ...
                default:
                    ModelState.AddModelError("", "Intento de inicio de sesión invalida.");
                    return View(model);
            }
        }
