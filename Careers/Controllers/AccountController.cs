    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user != null)
            {
                if (!await UserManager.IsEmailConfirmedAsync(user.Id))
                {
                    ...
                    ViewBag.errorMessage = "Debes confirmar tu correo para poder ingresar. "
                                         + "El vínculo de confirmación ha sido reenviado a tu correo electrónico.";
                    return View("Error");
                }
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Agisnación de roles por defecto
                    var roleresult = UserManager.AddToRole(user.Id, "Colaborador");

                    MessageSuccess("Usuario creado correctamente");

                    ViewBag.Message = "Revise su correo electrónico, debe de confirmar su cuenta antes de ingresar.";
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await SendRecoveryEmailAsync(user);
        ...
        #region Helpers
        // Usedf for XSRF protection when adding external logins
        ...
        private async Task SendConfirmationEmailAsync(ApplicationUser user)
        {
            ...
            string body = System.IO.File.ReadAllText(HostingEnvironment.MapPath("~/htmltemplates/EmailConfirmation.html"));
        ...
        /// <returns></returns>
        private async Task SendRecoveryEmailAsync(ApplicationUser user)
        {
            //Obtener Url de confirmación.
            ...
            //Crear el cuerpo del correo de confirmación
            string body = System.IO.File.ReadAllText(HostingEnvironment.MapPath("~/Content/htmltemplates/ResetPassword.html"));
